        ...
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <div className="panel" style={{ marginBottom: 24 }}>
            ...
            <p className="muted">
              ...
              or &quot;our&quot;), including our website and mobile applications (such as VerbaLearn), you agree 
          ...
          <div className="panel" style={{ marginBottom: 24 }}>
            <h2>User Content</h2>
            <p className="muted" style={{ marginBottom: 12 }}>
              When you submit content through our services (such as study materials in VerbaLearn), you retain ownership of your content. However, you grant us a license to use, 
